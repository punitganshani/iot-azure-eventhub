...
namespace shared
{
    public class Constants
    {
        ...
        public const string DefaultHubName = "inbox";
        public static string GetBusConnectionString(string serviceBus, string keyName, string hash)
        {
            return String.Format(ServiceBusConnectionStringFormat, serviceBus, keyName, hash);
        }

        public static string GetStorageConnectionString(string accountName, string key)
        {
            return String.Format(StorageConnectingStringFormat, accountName, key);
        }
    }
}
